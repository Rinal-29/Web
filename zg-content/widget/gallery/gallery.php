...
class Gallery implements ExtensionInterface
{
	...
	*/
    ...
    /**
	 * Fungsi ini digunakan untuk mengambil daftar semua album.
	 *
	 * This function use to get all list of album.
	 *
	 * $order = string
	 * $limit = integer
	*/
	public function getAllAlbum($order = 'id_album DESC', $limit)
    {
		$album = $this->core->podb->from('gallery')->orderBy($order)->limit($limit)->fetchAll();
        return $album;
    }
