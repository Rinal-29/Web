...
class Post implements ExtensionInterface
{
	...
	*/
    ...
    /**
	 * Fungsi ini digunakan untuk mengambil daftar post terkait berdasarkan kategori.
	 *
	 * This function use to get list of post base on category.
	 *
	 * $id_category = integer
	 ...
	 * $lang = WEB_LANG_ID
	*/
	public function getRelatedByCategory($id_post, $id_category, $limit, $order, $lang)
    {
		$post = array();
		$categorys = $this->core->podb->from('post_category')
			->where('id_category', $this->getCategoryParentTree($id_category))
