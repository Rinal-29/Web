								...
								<div class="form-group" id="image-box">
									<div class="row">
										...
										<?php } else { ?>
											...
											<div class="col-md-12">
												<a href="../zg-content/uploads/<?=$current_post['picture'];?>" target="_blank"><?=$GLOBALS['_']['post_picture_6'];?></a>
												<p>
					...
					<?=$this->pohtml->formStart(array('method' => 'post', 'action' => 'admin.php?mod=post&act=processimport', 'enctype' => true, 'autocomplete' => 'off'));?>
						<div class="row">
							<div class="col-md-12">
								<?php
									$item = array(
										array('value' => 'Zagitanank', 'title' => 'Zagitanank'),
						...
						if (!empty($_FILES['fupload']['tmp_name'])) {
							...
							if (($_FILES["fupload"]["size"] < 10000000) && in_array(end($exp), array('xml'))) {
								if (file_exists('../'.DIR_CON.'/uploads/'.$xmlfile)) {
									...
									<?php
									if ($this->postring->valid($_POST['from'], 'xss') == 'Zagitanank') {
