			...
			<div class="row">
				<div class="col-md-12">
                    ...
                    '<div class="btn-title pull-right">
					   <a href="admin.php?mod=pages&act=addnew" class="btn btn-success btn-sm"><i class="fa fa-plus"></i> '.$GLOBALS['_']['addnew'].'</a>
					</div>'
                    );?>
				</div>
			</div>
								...
								<div class="form-group" id="image-box">
									<div class="row">
										...
										<?php } else { ?>
											...
											<div class="col-md-10">
												<a href="../zg-content/uploads/<?=$current_pages['picture'];?>" target="_blank"><?=$GLOBALS['_']['pages_picture_6'];?></a>
												<p>
