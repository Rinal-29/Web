 ...
 * This is a main javascript file from Zagitanank which contains all javascript in pemdes.
 *
*/

$(document).ready(function() {
	$('#table-pemdes').buildtable('route.php?mod=pemdes&act=datatable');
});
...
$(document).ready(function() {
	...
	$('.btn-del-image').click(function () {
		...
		$.ajax({
			type: "POST",
			url: "route.php?mod=pemdes&act=delimage",
			data: dataString,
			cache: false,
