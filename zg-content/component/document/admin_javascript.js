 ...
 * This is a main javascript file from Zagitanank which contains all javascript in document.
 *
*/

$(document).ready(function() {
	$('#table-document').buildtable('route.php?mod=document&act=datatable');
});
...
$(document).ready(function() {
	...
	$('.btn-del-image').click(function () {
		...
		$.ajax({
			type: "POST",
			url: "route.php?mod=document&act=delimage",
			data: dataString,
			cache: false,
...
$(document).ready(function() {
	$('#table-category').buildtable('route.php?mod=document&act=datatable2');
});