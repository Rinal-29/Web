...
$router->match('GET|POST', '/feed', function () use ($core, $templates) {
	...
	$channel_node->appendChild($xml->createElement("generator", "http://www.Zagitanank.org")); //generator
	...
	foreach ($recents as $recent) {
		...
		$item_media->setAttribute("url", BASE_URL . '/zg-content/thumbs/' . $recent['picture']);
