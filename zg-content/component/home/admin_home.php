	...
	?>
		<div class="row">
			...
			<div class="col-md-4">
				<div class="widget">
					<div class="mini-stats">
						<a href="admin.php?mod=post"><span class="bg-info"><i class="fa fa-newspaper-o"></i></span></a>
						<p><?=$GLOBALS['_']['post'];?></p>
			...
			<div class="col-md-4">
				<div class="widget">
					<div class="mini-stats">
						<a href="admin.php?mod=document"><span class="bg-success"><i class="fa fa-book"></i></span></a>
						<p><?=$GLOBALS['_']['document'];?></p>
						<h3><?=$this->podb->from('document')->count();?></h3>
					</div>
				</div>
			</div>
						...
						<div class="media">
							...
							<div class="media-left">
								<a href="<?=$this->postring->permalink(rtrim(WEB_URL, '/'), $post_pop);?>" target="_blank">
									<img class="media-object" src="../zg-content/thumbs/<?=$post_pop['picture'];?>" width="64" />
								</a>
							</div>
							<?php } ?>
