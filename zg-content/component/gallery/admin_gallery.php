						...
						<div class="row">
							<div class="col-md-12">
								<div class="form-group">
									...
									<textarea id="Zagitanankwysiwyg" name="content" class="form-control" style="width:100%; height:300px;"></textarea>
								</div>
							</div>
						</div>
						<div class="row">
					...
					<?=$this->pohtml->formStart(array('method' => 'post', 'action' => 'route.php?mod=gallery&act=edit', 'autocomplete' => 'off'));?>
						...
						<div class="row">
							<div class="col-md-12">
								<div class="form-group">
									<label for="message"><?=$GLOBALS['_']['gallery_content'];?></label>
									<textarea id="Zagitanankwysiwyg" name="content" class="form-control" style="width:100%; height:300px;"><?=html_entity_decode($current_gallery['content']);?></textarea>
								</div>
							</div>
						</div>
						<div class="row">
