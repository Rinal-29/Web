							...
							<div class="table-responsive">
								<table class="table table-striped table-hover table-setting">
									...
									<tr>
										...
										<td class="link-setting">
											<a href="javascript:void(0)" id="geocode" data-type="textarea" data-pk="10" data-url="route.php?mod=setting&act=edit" title="<?=$GLOBALS['_']['setting_edit_tooltip'];?>"><?=$settings[9]['value'];?></a>
										</td>
									</tr>
								</table>
							</div>
