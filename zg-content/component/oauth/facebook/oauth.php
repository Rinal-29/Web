...
<html lang="en">
	<head>
		...
		<meta name="description" content="ZagiTanankOAuth 1.0 - Connect facebook to your website for automatic publish content to facebook from your post">
		<meta name="author" content="ZagiTanank">
		<link rel="shortcut icon" href="../../../../<?=DIR_INC;?>/images/favicon.png">
		<title>ZagiTanankOAuth 2.0 - Facebook</title>
		<!-- Bootstrap core CSS -->
	...
	<body>
		...
		<div id="footer">
			<div class="container">
				<p class="text-muted">ZagiTanankOAuth 2.0 &copy; 2014-2016. ZagiTanank Team. All Rights Reserved.</p>
			</div>
		</div>
