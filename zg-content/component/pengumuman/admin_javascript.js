 ...
 * This is a main javascript file from Zagitanank which contains all javascript in pengumuman.
 *
*/

$(document).ready(function() {
	$('#table-pengumuman').buildtable('route.php?mod=pengumuman&act=datatable');
});
...
$(document).ready(function() {
	...
	$('.btn-del-image').click(function () {
		...
		$.ajax({
			type: "POST",
			url: "route.php?mod=pengumuman&act=delimage",
			data: dataString,
			cache: false,
