            ...
            var a, i = {
                ...
                loadResource: function(e, t) {
                    ...
                    for (n in i.libs.namespaces) {
                        var d = i.libs.namespaces[n],
                            c = e.toLowerCase(),
                            p = n.toLowerCase();
                        if (-1 != c.indexOf(p) && void 0 !== window[d]) {
                            o = !0;
                            break
                        }
                    }
                ...
                toArray: function(e, t) {
                    function a(e, t) {
                        ...
                        return c ? i.handleCallback(c, e, t) : e
                    }
                        ...
                        if (d = [], !isNaN(n)) {
                            for (p in l)
                                if (!isNaN(p)) {
                                    var p = l[p],
                                        f = o.data[n][p];
                                    f = null == f ? "" : o.stringify ? String(f) : f, d.push(r(f))
                                }
                            s.push(d)
                        }
                ...
                clear: function() {
                    var e, t;
                    for (e = 0; e < i.listenersToRemove.length; e++)(t = i.listenersToRemove[e]).node.removeEventListener(t.event, t.method);
