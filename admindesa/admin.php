...
if (VQMOD == TRUE) {
	...
	VQMod::bootup();
	include_once VQMod::modCheck('../zg-includes/core/core.php');
} else {
...
?>
		...
		<head>
			...
			<title><?php $titcomponame = ucfirst($_GET['mod']);
					if ($_SESSION['leveluser'] == '1' or $_SESSION['leveluser'] == '2') {
						echo $titcomponame; ?> - Administrator Dashboard<?php } else {
																																													echo $titcomponame; ?> - Member Dashboard<?php } ?></title>
			...
			<link type="text/css" rel="stylesheet" href="../<?= DIR_INC; ?>/css/bootstrap-colorpicker.min.css" />
    ...
    <![endif]-->
		...
		<body class="fixed-left">
			...
			<script type="text/javascript" src="../<?= DIR_INC; ?>/js/colorpicker/bootstrap-colorpicker.min.js"></script>
