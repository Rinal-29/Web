...
class PoDateTime
{
	...
	*/
    ...
    /**
	 * Fungsi ini digunakan untuk membuat tanggal dan hari dalam bahasa Indonesia
	 *
	 * This function use for create date and day in Indonesian language
	 *
	 * $tgl = date
	*/
	public function tgl_indo_day($tgl)
	{
		$tanggal = substr($tgl,8,2);
		$bulan = $this->getBulan(substr($tgl,5,2));
		$tahun = substr($tgl,0,4);
    ...
    /**
	 * Fungsi ini digunakan untuk membuat tanggal dalam bahasa Inggris
	 *
	 * This function use for create date in English language
	 *
	 * $tgl = date
	*/
	public function tgl_global($tgl)
	{
		$tanggal = substr($tgl,8,2);
		$bulan = $this->getBulan(substr($tgl,5,2));
		$tahun = substr($tgl,0,4);
        
		return $bulan.' '.$tanggal.'th, '.$tahun;
	}
    
    /**
	 * Fungsi ini digunakan untuk membuat tanggal dalam bahasa global
	 *
	 * This function use for create date in global language
	 *
	 * $tgl = date
	*/
	public function tgl_global_day($tgl)
	{
        $tanggal = substr($tgl,8,2);
		$bulan = $this->getMonth(substr($tgl,5,2));
		$tahun = substr($tgl,0,4);
        
        $day = date('D', strtotime($tgl));
		return $day. ', ' .$bulan.' '.$tanggal.'th, '.$tahun;
	}
	...
	*/
    ...
    /**
	 * Fungsi ini digunakan untuk membuat nama bulan dalam bahasa Inggris
	 *
	 * This function use for create month in English language
	 *
	 * $bln = integer
	*/
    ...
    /**
	 * Fungsi ini digunakan untuk membuat nama bulan dalam bahasa Inggris versi pendek
	 *
	 * This function use for create month in English language short version
	 *
	 * $bln = integer
	*/
