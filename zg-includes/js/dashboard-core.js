 ...
 *
 *
 * Ini adalah file utama javascript Zagitanank yang memuat semua javascript di dashboard.
 * This is a main javascript file from Zagitanank which contains all javascript in dashboard.
 *
*/
...
function($) {
	...
	var App = function() {
		this.VERSION = "1.0",
		this.AUTHOR = "Zagitanank",
		this.SUPPORT = "info@Zagitanank.org",
